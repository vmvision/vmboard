...
interface VMsTableContextProps {
  featureFlags: FeatureFlagValue[];
  setFeatureFlags: (value: FeatureFlagValue[]) => void;
}

const VMsTableContext = React.createContext<VMsTableContextProps>({
  featureFlags: [],
  setFeatureFlags: () => {},
});

export function useTasksTable() {
  const context = React.useContext(VMsTableContext);
  if (!context) {
